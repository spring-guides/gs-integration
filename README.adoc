...
You can use this https://start.spring.io/#!type=gradle-project&groupId=com.example&artifactId=integration&packageName=com.example.integration&dependencies=integration[pre-initialized project] and click Generate to download a ZIP file. This project is configured to fit the examples in this tutorial.
