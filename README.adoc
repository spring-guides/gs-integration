...
You can use this https://start.spring.io/#!type=gradle-project&jvmVersion=17&packaging=jar&groupId=com.example&artifactId=integration&packageName=com.example.integration&dependencies=integration[pre-initialized project] and click Generate to download a ZIP file. This project is configured to fit the examples in this tutorial.
...
.Gradle (Kotlin)
----
include::complete-kotlin/build.gradle.kts[]
----
...
listing shows the application file:
...
.Kotlin
----
include::complete-kotlin/src/main/kotlin/com/example/integration/IntegrationApplication.kt[]
----
...
After the application has been running for a while, you should be able to view the file at
...
Examine the `complete` (or `complete-kotlin`) project and find the `FlowTests` test case:
...
.Kotlin
----
include::complete-kotlin/src/test/kotlin/com/example/integration/FlowTests.kt[]
----
